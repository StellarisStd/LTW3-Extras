...
setblock 1100 30 1202 structure_block[mode=load]{metadata: "", mirror: "NONE",ignoreEntities: 1b, powered: 0b, seed: 0L, rotation: "NONE", posX: 0, posY: 1,posZ: 0, sizeX: 26, sizeY: 26, sizeZ: 26, mode: "LOAD", integrity: 1.0f, showair:0b, name: "mini:zom"}
